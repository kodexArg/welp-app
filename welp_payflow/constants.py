...
PAYFLOW_STATUSES = {
    ...
    'closed': {
        ...
        'non_owner_message': '⚠️ <strong>ADVERTENCIA</strong>: Está cerrando un ticket que NO ES PROPIO, creado por <strong>{owner_name}</strong> ({owner_username}). Esta acción descartará completamente la solicitud. Debe proporcionar una razón clara y justificada para el cierre.',
        'confirmation_style': {'bg': 'bg-yellow-50', 'border': 'border-yellow-400', 'text': 'text-yellow-700'},
