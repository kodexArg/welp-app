...
PAYFLOW_STATUSES = {
    ...
    'authorized': {
        ...
        'action_verb': 'Solicitud autorizada por',
    ...
    'processing_payment': {
        ...
        'action_verb': 'Enviado a `Pagos y Proveedores` por',
    ...
    'shipping': {
        ...
        'action_label': 'Envío',
        'action_verb': 'Envío gestionado por',
