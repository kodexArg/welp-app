...
PAYFLOW_STATUSES = {
    ...
    'budgeted': {
        ...
        'is_active': True,
        'is_final': False,
        'transitions': ['authorized_by_manager', 'rejected', 'closed'],
        'allowed_roles': ['purchase_manager', 'technician'],
        'flow': {
            'current_action': 'Esperando primera autorización de pago',
            'next_action': 'Primera firma (Manager)',
    ...
    'authorized_by_manager': {
        ...
        'is_active': True,
        'is_final': False,
        'transitions': ['authorized_by_director', 'closed'],
        'allowed_roles': ['manager'],
        'flow': {
            'current_action': 'Esperando segunda autorización de pago',
            'next_action': 'Segunda firma (Director)',
            'responsible_roles': ['director'],
            'is_waiting': True,
            'priority': 'high',
        },
        'action_label': 'Primera Firma',
        'action_verb': 'Autorizado por Manager',
        'color_class': 'text-orange-500',
        'confirmation_message': '¿Confirmar primera autorización? Se notificará al Director para la segunda firma.',
        'confirmation_style': {'bg': 'bg-orange-50', 'border': 'border-orange-400', 'text': 'text-orange-700'},
        'button_text': 'Autorizar (Primera Firma)',
    ...
    'authorized_by_director': {
        ...
        'is_active': True,
        'is_final': False,
        'transitions': ['payment_authorized'],
        'allowed_roles': ['director'],
        'flow': {
            'current_action': 'Segunda firma completada',
            'next_action': 'Automático → Pago Autorizado',
            'responsible_roles': ['system'],
            'is_waiting': False,
            'priority': 'medium',
        },
        'action_label': 'Segunda Firma',
        'action_verb': 'Autorizado por Director',
        'color_class': 'text-purple-500',
        'confirmation_message': '¿Confirmar segunda autorización? El pago será autorizado automáticamente.',
        'confirmation_style': {'bg': 'bg-purple-50', 'border': 'border-purple-400', 'text': 'text-purple-700'},
        'button_text': 'Autorizar (Segunda Firma)',
...
FA_ICONS = {
    ...
    'authorized_by_manager': 'fa-solid fa-user-tie',
    'authorized_by_director': 'fa-solid fa-user-secret',
