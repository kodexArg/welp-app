...
PAYFLOW_STATUSES = {
    ...
    'authorized_by_manager': {
        ...
        'is_active': True,
        'is_final': False,
        'transitions': ['authorized_by_director', 'payment_authorized', 'closed'],
        'allowed_roles': ['manager'],
        'flow': {
            'current_action': 'Manager ha autorizado, esperando Director',
            'next_action': 'Autorización Director',
        ...
        'button_text': 'Autorizar como Manager',
    ...
    'authorized_by_director': {
        ...
        'is_active': True,
        'is_final': False,
        'transitions': ['authorized_by_manager', 'payment_authorized', 'closed'],
        'allowed_roles': ['director'],
        'flow': {
            'current_action': 'Director ha autorizado, esperando Manager',
            'next_action': 'Autorización Manager',
        ...
        'button_text': 'Autorizar como Director',
